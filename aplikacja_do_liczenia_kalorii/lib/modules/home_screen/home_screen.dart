...
import 'package:aplikacja_do_liczenia_kalorii/modules/home_screen/add_meal_dialog.dart';
import 'package:aplikacja_do_liczenia_kalorii/modules/home_screen/build_header.dart';
          ...
          children: [
            ...
            FloatingActionButton(
              onPressed: (){
                showDialog(
                  context: context,
                  builder: (context) => const ClearAllDialog()
                );
              },
              tooltip: "Wyczyść",
              heroTag: "clear_meals",
